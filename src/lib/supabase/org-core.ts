...
export type OrgSupabaseClient = SupabaseClient<any, "public", any>;

export function getServiceRoleClient(): OrgSupabaseClient | null {
...
export async function queryGetUserOrgs(
...
export async function queryGetOrgBySlug(
  supabase: OrgSupabaseClient,
  slug: string
...
export async function queryGetOrgMembers(
  supabase: OrgSupabaseClient,
  orgId: string
...
export async function queryInviteMember(
  supabase: OrgSupabaseClient,
  orgId: string,
  email: string,
  invitedBy: string
...
export async function queryCreateOrganizationWithAdmin(
  supabase: OrgSupabaseClient,
  userId: string,
  input: {
    name: string;
...
export async function queryGetOrgMembershipForUser(
  supabase: OrgSupabaseClient,
  orgId: string,
  userId: string
