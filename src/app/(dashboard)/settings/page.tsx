...
<Card>
<CardHeader title="Scheduled Tasks" description="Automated cron-based tasks" />
<div className="p-5">
<div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-[var(--bg-app)] border border-[var(--border-subtle)]">
<Clock className="w-4 h-4 shrink-0 text-[var(--fg-muted)]" />
<p className="text-xs text-[var(--fg-tertiary)]">
Scheduled tasks are coming soon. Background automation will be powered by Inngest.
</p>
</div>
</div>
</Card>
