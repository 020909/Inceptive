  ...
  return (
    <main className="flex-1 overflow-auto p-8">
        <div className="max-w-2xl mx-auto text-center">
          <Search className="w-16 h-16 mx-auto mb-6 text-[var(--accent)]" />
          <h1 className="text-4xl font-bold mb-4 text-[var(--fg-primary)]">
            Audit Trail
          </h1>
          <p className="text-lg text-[var(--fg-muted)] mb-8">
            View immutable records of all compliance activities, AI decisions, and human approvals for regulatory reporting.
          </p>
          <button
