      ...
      <main className="flex-1 overflow-auto p-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-lg text-[var(--fg-muted)] mb-8">
            Upload corporate documents to extract complete ownership structures, identify beneficial owners, check sanctions lists, and generate compliance memos in seconds.
          </p>
          <button
