...
export default function Plan() {
  ...
  const transitionType = prefersReducedMotion ? ("tween" as const) : ("spring" as const);
                    ...
                    >
                      ...
                      <motion.div className="flex min-w-0 flex-grow cursor-pointer items-center justify-between" onClick={() => toggleTaskExpansion(task.id)}>
                        <div className="mr-2 flex-1 truncate">
                          <span className={`${isCompleted ? "text-white/45 line-through" : ""}`}>{task.title}</span>
                        </div>
                            ...
                            <div className="flex items-center mr-2">
                              <div className="flex flex-wrap gap-1">
                                {task.dependencies.map((dep, idx) => (
                                  <motion.span
                                    key={idx}
                                    className="rounded px-1.5 py-0.5 text-[10px] font-medium bg-white/[0.06] text-white/70 border border-white/[0.06]"
                                ...
                                : task.status === "in-progress"
                                  ...
                                  : task.status === "need-help"
                                    ...
                                    : task.status === "failed"
                                      ...
                                      : "bg-white/[0.06] text-white/60 border-white/[0.06]"
                            }`}
                              ...
                              return (
                                ...
                                >
                                  ...
                                  >
                                      ...
                                      <AnimatePresence mode="wait">
                                        ...
                                        >
                                          {subtask.status === "completed" ? (
                                            ...
                                            <CircleDotDashed className="h-3.5 w-3.5 text-[#3b82f6]" />
                                    ...
                                    <span className={`cursor-pointer text-sm ${subtask.status === "completed" ? "text-white/45 line-through" : ""}`}>
                                      {subtask.title}
                                    </span>
                                  </motion.div>
                                  ...
                                  <AnimatePresence mode="wait">
                                    {isSubtaskExpanded && (
                                      <motion.div
                                        className="mt-1 ml-1.5 border-l border-dashed border-white/15 pl-5 text-xs overflow-hidden text-white/60"
                                      ...
                                      >
                                        ...
                                        {subtask.tools && subtask.tools.length > 0 && (
                                          <div className="mt-0.5 mb-1 flex flex-wrap items-center gap-1.5">
                                            <span className="font-medium text-white/50">MCP Servers:</span>
                                            <div className="flex flex-wrap gap-1">
