  ...
  return (
    <Button
      ...
      className={cn(
        ...
        "group-data-[state=collapsed]:translate-x-6 group-data-[state=collapsed]:bg-[var(--bg-surface)] group-data-[state=collapsed]:border group-data-[state=collapsed]:border-[var(--border-default)] group-data-[state=collapsed]:shadow-sm",
        className
      )}
      onClick={(event) => {
        onClick?.(event)
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-all duration-200 ease-out hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:translate-x-[2px] focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 group-data-[collapsible=icon]:hover:!translate-x-0 [&>span:last-child]:truncate [&>svg]:size-[18px] [&>svg]:shrink-0",
  {
    variants: {
      ...
      size: {
        default: "h-9 text-[1.05rem] leading-snug",
        sm: "h-7 text-xs",
